...
#define XMTP2KM_IOCS_STARTLINK 	_IOW (XMTP2KM_IOC_MAGIC,  5, uint8_t *)
#define XMTP2KM_IOCG_GETMSU 	_IOR (XMTP2KM_IOC_MAGIC,  6, uint8_t *)
#define XMTP2KM_IOCS_PUTMSU 	_IOW (XMTP2KM_IOC_MAGIC,  7, uint8_t *)
#define XMTP2KM_IOCX_GETTBQ 	_IOWR(XMTP2KM_IOC_MAGIC,  8, uint8_t *)
#define XMTP2KM_IOCS_LNKRCVY 	_IOW (XMTP2KM_IOC_MAGIC,  9, uint32_t)
#define XMTP2KM_IOCX_GETBSNT 	_IOWR(XMTP2KM_IOC_MAGIC,  10, uint8_t *)
#define XMTP2KM_IOCS_STOPLINK 	_IOW (XMTP2KM_IOC_MAGIC,  11, uint8_t *)
#define XMTP2KM_IOCG_GETOPM 	_IOR (XMTP2KM_IOC_MAGIC,  12, uint8_t *)
