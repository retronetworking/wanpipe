				...
				IN		UINT32							f_ulTlvValueAddress )
{
	...
	case cOCT6100_TLV_TYPE_RESET_RIN_ALC_ON_TONES_BOFF:
		
		ulResult = Oct6100ApiTlvCheckLengthField( f_ulTlvFieldLength, 
												  cOCT6100_TLV_MIN_LENGTH_RESET_RIN_ALC_ON_TONES_BOFF, 
												  cOCT6100_TLV_MAX_LENGTH_RESET_RIN_ALC_ON_TONES_BOFF );
		if ( ulResult == cOCT6100_ERR_OK )
		{
			ulResult = Oct6100ApiTlvReadBitOffsetStruct( f_pApiInstance,
											f_ulTlvValueAddress, 
											&f_pApiInstance->pSharedInfo->MemoryMap.ResetRinAlcOnTonesFieldOfst );

			f_pApiInstance->pSharedInfo->ImageInfo.fResetRinAlcOnTones = TRUE;
		}

		break;

	case cOCT6100_TLV_TYPE_RESET_SOUT_ALC_ON_TONES_BOFF:
		
		ulResult = Oct6100ApiTlvCheckLengthField( f_ulTlvFieldLength, 
												  cOCT6100_TLV_MIN_LENGTH_RESET_SOUT_ALC_ON_TONES_BOFF, 
												  cOCT6100_TLV_MAX_LENGTH_RESET_SOUT_ALC_ON_TONES_BOFF );
		if ( ulResult == cOCT6100_ERR_OK )
		{
			ulResult = Oct6100ApiTlvReadBitOffsetStruct( f_pApiInstance,
											f_ulTlvValueAddress, 
											&f_pApiInstance->pSharedInfo->MemoryMap.ResetSoutAlcOnTonesFieldOfst );

			f_pApiInstance->pSharedInfo->ImageInfo.fResetSoutAlcOnTones = TRUE;
		}

		break;

	case cOCT6100_TLV_TYPE_ALC_NOISE_BLEED_OUT_TIME_BOFF:
		
		ulResult = Oct6100ApiTlvCheckLengthField( f_ulTlvFieldLength, 
												  cOCT6100_TLV_MIN_LENGTH_ALC_NOISE_BLEED_OUT_TIME_BOFF, 
												  cOCT6100_TLV_MAX_LENGTH_ALC_NOISE_BLEED_OUT_TIME_BOFF );
		if ( ulResult == cOCT6100_ERR_OK )
		{
			ulResult = Oct6100ApiTlvReadBitOffsetStruct( f_pApiInstance,
											f_ulTlvValueAddress, 
											&f_pApiInstance->pSharedInfo->MemoryMap.AlcNoiseBleedOutTimeFieldOfst );

			f_pApiInstance->pSharedInfo->ImageInfo.fAlcNoiseBleedOutTime = TRUE;
		}
