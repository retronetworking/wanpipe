...
public:
	...
	int set_registry_configration(port_cfg_t *port_cfg);

	int set_t1_tdm_span_voice_api_configration(port_cfg_t *port_cfg, hardware_info_t *hardware_info, int span);
	int set_e1_tdm_span_voice_api_configration(port_cfg_t *port_cfg, hardware_info_t *hardware_info, int span);
};
