...
extern int	wanpipe_min_port_no;
...
extern int  dtmf_seq_check;

#define WP_LIB_IFNAME_SZ 512

extern unsigned char tx_file[WP_LIB_IFNAME_SZ];
extern unsigned char rx_file[WP_LIB_IFNAME_SZ];
