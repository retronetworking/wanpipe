...
#define api_tx_hdr_event_type		u.event.type
#define api_tx_hdr_event_mode 		u.event.mode
#define api_tx_hdr_event_tone 		u.event.tone
#define api_tx_hdr_event_channel 	u.event.channel
} api_tx_hdr_t;
...
typedef struct private_area
{
	...
	unsigned int 		num_of_time_slots;
	long          		logic_ch_num;
...
//	char tx_idle_buff[MAX_WP_PRI_MTU];
	TX_DATA_STRUCT	tx_idle_buff;
#endif
