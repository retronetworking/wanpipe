...
//LIP CHDLC - in seconds
#define LIP_MIN_Tx_KPALV_TIMER		1		/* minimum transmit keepalive timer */
#define LIP_MAX_Tx_KPALV_TIMER		60	  /* maximum transmit keepalive timer */
#define LIP_DEFAULT_Tx_KPALV_TIMER	10	  /* default transmit keepalive timer */
...
//LIP CHDLC - in seconds
#define LIP_MIN_Rx_KPALV_TIMER		1	/* minimum receive keepalive timer */
#define LIP_MAX_Rx_KPALV_TIMER		60	/* maximum receive keepalive timer */
#define LIP_DEFAULT_Rx_KPALV_TIMER	10	/* default receive keepalive timer */
